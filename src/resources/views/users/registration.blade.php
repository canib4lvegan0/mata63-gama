...
<body>
<div class="page">
    <h1 id="test">Cadastrar Aluno</h1>
    <form action="{{ route('cadastrar_aluno')   }}" method="post" enctype="multipart/form-data">
        @csrf
        @if($errors->any())
...
{{--        </div>--}}
        <div class="form-group">
            ...
            <label>
                <input type="text" class="form-control" name="areas_interest" value="interesse1, interesse 2, interesse 3">
            </label>
        </div>
        <div class="form-group">
